...
/***/ function(module, exports, __webpack_require__) {
	...
	var ScatterPlot = __webpack_require__(19);
	var LineChart = __webpack_require__(1);
	var AreaChart = __webpack_require__(20);
	var Brush = __webpack_require__(21);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DefaultPropsMixin = __webpack_require__(2);
	...
	var DefaultScalesMixin = __webpack_require__(12);
	var TooltipMixin = __webpack_require__(13);
	...
	var DataSet = React.createClass({
	   ...
	   */
			...
			return React.createElement(
				...
				lines,
				React.createElement("rect", { width: width, height: height, fill: "none", stroke: "none", style: { pointerEvents: showTooltip ? "all" : "none" },
	...
	var LineChart = React.createClass({
	  ...
	  */
		_tooltipHtml: function _tooltipHtml(data, position) {
			...
			var xIndex = xBisector(values(data[0]), xScale.invert(position[0]));
			xIndex = xIndex == values(data[0]).length ? xIndex - 1 : xIndex;

			var xIndexRight = xIndex == values(data[0]).length ? xIndex - 1 : xIndex;
			var xValueRight = x(values(data[0])[xIndexRight]);

			var xIndexLeft = xIndex == 0 ? xIndex : xIndex - 1;
			var xValueLeft = x(values(data[0])[xIndexLeft]);
	  ...
	  */
		render: function render() {
			...
			if (!this.state.tooltip.hidden) {
				...
				tooltipSymbol = this.state.tooltip.hidden || !this.props.showTooltipDot ? null : React.createElement("path", {
					className: "dot",
					d: symbol(),
					transform: translate,
					fill: symbolColor,
	...
	var Axis = React.createClass({
		...
		render: function render() {
			...
			if (orientation === "bottom" || orientation === "top") {
				...
				labelElement = React.createElement(
					"text",
					{ className: "" + className + " label", textAnchor: "end", y: -20, x: -5, dy: ".75em" },
					label
				);
			}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Path = React.createClass({
		...
		propTypes: {
			className: React.PropTypes.string,
			stroke: React.PropTypes.oneOfType([React.PropTypes.string, React.PropTypes.number, React.PropTypes.object]),
			strokeLinecap: React.PropTypes.oneOfType([React.PropTypes.string, React.PropTypes.number]),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Tooltip = React.createClass({
		...
		propTypes: {
			...
			html: React.PropTypes.oneOfType([React.PropTypes.string, React.PropTypes.element]) },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Chart = __webpack_require__(5);
	var Axis = __webpack_require__(6);
	var Bar = __webpack_require__(15);
	var Tooltip = __webpack_require__(8);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DataSet = React.createClass({
		...
		render: function render() {
			...
			var strokeWidth = _props.strokeWidth;
			var stroke = _props.stroke;
			var wedgeStroke = _props.wedgeStroke;
			var wedgeStrokeWidth = _props.wedgeStrokeWidth;
			...
			var wedges = pie.map(function (e, index) {
				...
				var d = arc(e);
				var polyline = React.createElement("span", null);
				var textComponent = React.createElement("span", null);
				...
				textComponent = React.createElement(
					"text",
					{
						opacity: showLabel ? opacity : 0,
						dy: ".35em",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DataSet = React.createClass({
		...
		render: function render() {
			...
			var colorScale = _props.colorScale;
			var stroke = _props.stroke;
			var lineStrokeWidth = _props.lineStrokeWidth;
			var values = _props.values;
			var showTooltip = _props.showTooltip;
			var label = _props.label;
			var onMouseEnter = _props.onMouseEnter;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function getResizerElement(e, width, height, style, isEmpty, xExtent, yExtent, onMouseDown) {
		var extentSelectorStyle = { cursor: _d3_svg_brushCursor[e] };
	...
	function getBackgroundElement(style, xRange, yRange, height, onMouseDown) {
		var backgroundStyle = { visibility: "visible", cursor: "crosshair" };
	...
	var Brush = React.createClass({
	   ...
	   */
		...
		render: function render() {
			...
			var background = this.props.getBackgroundElement(this.props.backgroundStyle, xRange, yRange, this._innerHeight, this._onMouseDownBackground);
			...
			if (this.props.xScale) {
				extent = this.props.getExtentElement(this.props.extentStyle, this.state.xExtent, this._innerHeight, this._onMouseDownExtent);
			}

			var resizers = this.state.resizers.filter(function (e) {
				if (_this.props.lockExtent === "right" && e === "e" || _this.props.lockExtent === "left" && e === "w") {
					return false;
				}
				return true;
			}).map(function (e) {
				// (e, width, height, style, isEmpty, xExtent, yExtent, onMouseDown)
				return _this.props.getResizerElement(e, 10, _this._innerHeight, _this.props.extentSelectorStyle, _this._empty(), _this.state.xExtent, _this.state.yExtent, _this._onMouseDownResizer);
			});
		...
		callOnChangeCallback: function callOnChangeCallback() {
